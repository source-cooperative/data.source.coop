...
| `DEFAULT_CACHE_CONTROL`      | `no-cache`                  | `Cache-Control` added to read responses whose backend sets none. Never overrides a value the object carries. Empty string = send no header |
